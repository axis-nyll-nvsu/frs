            ...
            <div class="box">
              <div class="box-header with-border">
                <div style="position: relative">
                  ...
                  <a href="cashflow_statement_print.php?period=<?php echo $period; ?>" class="btn btn-sm btn-flat axis-btn-green" style="position: absolute; top: 0; right: 0;"><i class="fa fa-print"></i> Print Statement of Cash Flows</a>
